                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            $queryKaryawan = "SELECT * FROM karyawan WHERE nama IS NOT NULL";
                                            ...
                                            if ($resultKaryawan->num_rows > 0) {
                                                while ($rowKaryawan = $resultKaryawan->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $rowKaryawan['email'] ?> </td>
                                                        <td><?= $rowKaryawan['jk'] ?> </td>
                                                        <td class="text-center">
                                                            <a href="../admin/update_user.php?uid=<?= $rowKaryawan['uid'] ?>" class="mr-3">
                                                                <button type="button" class="btn btn-success">Upadate</button>
                                                            </a>
                                                            <a href="../api/delete_karyawan.php?uid=<?= $rowKaryawan['uid'] ?>">
