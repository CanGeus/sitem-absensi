...
$sql = 'SELECT * FROM absensi JOIN karyawan ON karyawan.uid=absensi.uid WHERE karyawan.nama IS NOT NULL';
        ...
        <div class="sidebar" data-color="white" data-active-color="danger">
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="active-pro">
                        <a href="./user.html" class="text-danger">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:;">Export Data</a>
                    </div>
